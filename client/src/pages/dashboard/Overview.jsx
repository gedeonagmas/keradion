...
const Overview = () => {
  ...
  return (
    <div className="min-h-[82vh] pb-10 pr-10">
      ...
      <p>
        Keradion Designs stands as the preferred partner for numerous top
        Ethiopian enterprises, SMEs, and technology innovators. Our mission is
        to enhance the value of businesses through tailor-made software
        development, innovative product design, rigorous QA testing, and expert
      ...
      <div className="w-full flex items-center justify-between flex-col lg:flex-row gap-5">
        <div className="w-full">
          <p className="text-xl font-bold text-main mt-5 mb-2">
            {user?.role === "admin" ? "Total" : "Your"} Invoices
          </p>
          <a
          ...
          >
            <div className="flex items-center justify-between w-full">
              <p className="text-lg font-bold ">Invoices</p>
              <svg
